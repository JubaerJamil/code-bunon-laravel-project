            ...
            <div class="col-lg-8">
                <div class="case-article">
                    <div class="case-article-img">
                        <img src="frontend-asset/images/case-study/case-details.jpg" alt="Images">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="case-article-another-img">
                                    <img src="frontend-asset/images/case-study/case-study1.jpg" alt="Images">
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="case-article-another-img">
                                    <img src="frontend-asset/images/case-study/case-study5.jpg" alt="Images">
                                </div>
                            </div>
                        </div>
                        <p>
                ...
                <div class="side-bar-area">
                        ...
                        <div class="side-bar-categories">
                            <ul>
                                <li>
                                    ...
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Web Development</a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Social Media App</a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">UI/UX Research</a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Business Reform</a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Consulting </a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Data Analysis</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="side-bar-widget">
                        ...
                        <ul class="side-bar-widget-tag">
                            <li><a href="{{ url('/case-study-details')}}" target="_blank">Android</a></li>
                            <li><a href="{{ url('/case-study-details')}}" target="_blank">Creative</a></li>
                            <li><a href="{{ url('/case-study-details')}}" target="_blank">App</a></li>
                            <li><a href="{{ url('/case-study-details')}}" target="_blank">IOS</a></li>
                            <li><a href="{{ url('/case-study-details')}}" target="_blank">Business</a></li>
                            <li><a href="{{ url('/case-study-details')}}" target="_blank">Consulting</a></li>
                        </ul>
                    </div>
                    <div class="side-bar-widget">
                    ...
                    <div class="side-bar-widget">
                        ...
                        <div class="side-bar-categories">
                            <ul>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Design<span>[70]</span></a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Business<span>[24]</span></a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Development<span>[08]</span></a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Technology <span>[17]</span></a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Startup <span>[20]</span></a>
                                </li>
                                <li>
                                    <div class="line-circle"></div>
                                    <a href="{{ url('/case-study-details')}}" target="_blank">Marketing Growth <span>[13]</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
