      ...
      <div class="card">
          <div class="card-body">
            <form action="{{ Route('service_Create') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <h5 class="font-weight-bolder">Service Item Createdsfdsf</h5>
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                    ...
                    <input type="text" class="form-control" id="icon" placeholder="Icon code" value="{{ old('icon') }}"
                        name="icon"  />
                    @error('icon')
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                    ...
                    <textarea name="content" class="form-control" id="myContent" cols="35" rows="30">{{ old('content') }}</textarea>
                    @error('content')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 mb-2 mt-2">
                ...
                <img src="" alt="Image Preview" id="title_img" class="mt-3 rounded float-start"
